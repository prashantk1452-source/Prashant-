...
### Project 4: Customer Shopping Behavior Analysis (Separate Repository)

A complete end-to-end data analytics workflow — Python, SQL, and Power BI.  
📎 **Repository:** [github.com/prashantk1452-source/customer-shopping-analysis](https://github.com/prashantk1452-source/customer-shopping-analysis)

- Python EDA notebook (cleaning, imputation, feature engineering)
- 10 SQL analysis queries (CTEs, window functions, segmentation)
- Interactive Power BI dashboard
- 3,900-row retail dataset + report + presentation
